...
const scenes = [
    ...
    {
        bg: "/static/images/chatbot/opening/house_outside.png",
        type: "intro",
        name: "브로 오드",
        title: "사회성 테러리스트",
        titleSize: "23px", statsSize: "18px",
...
function checkNext() {
    ...
    const isLastSeg = !isIntroType && (segIdx >= scenes[sceneIdx].segments.length - 1);

    if (isLastScene && (isIntroType || isLastSeg)) {
        // 모든 연출 종료 시 '이야기 시작하기' 버튼 노출
        setTimeout(() => {
